  ...
  return fetch(
    ...
    .then((data) => {
      ...
      for (var i = 0; i < timeArray.length; i++) {
        ...
        var year =
          timeArray[i][0].toString() +
          timeArray[i][1].toString() +
          timeArray[i][2].toString() +
          timeArray[i][3].toString();
        var hour = timeArray[i][8].toString() + timeArray[i][9].toString();

        dates[i] = date;

        dataHours += `
        <div class="col-md my-3 d-flex">
        <div class="card text-white bg-primary mb-3">
        <div class="card-body">
        
        <div class="box">
            <h3>${hour}.00</h3>
            <img src="icons/w_${parseInt(
              weatherArray[i]
            )}.png" width="50px"><br>
